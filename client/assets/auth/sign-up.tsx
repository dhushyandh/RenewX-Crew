...
export default function SignUpPage() {
    ...
    const validateForm = () => {
        ...
        /*
         * Password only needs to be at least
         * 8 characters long.
         */
                            ...
                            <View className="w-full">
                                ...
                                <View className="mb-4">
                                    <Text className="text-xs font-bold text-gray-700 uppercase tracking-wider mb-1.5">
                                        Password *
                                        {" "}
                                        <Text className="font-normal normal-case tracking-normal text-gray-500">
                                            (minimum 8
                                            characters)
                                        </Text>
                                    </Text>
